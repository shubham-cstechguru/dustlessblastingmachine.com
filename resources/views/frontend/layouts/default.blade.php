...
<!--        </div>-->
  	...
  	@section('footer')
        ...
        <p class="text-white text-center mt-5">Copyright &copy; All rights reserved Dustless blasting machine. Website Design and Developed by <a href="https://www.suncitygroup.org/" target="_blank">Suncity Group</a></p>
   ...
   <div class="sticky-container">
		<ul class="sticky">
			...
			<li>
				<p><a href="tel:{{ $setting->mobile_no }}"><i class="icon-whatsapp"></i> WhatsApp</a></p>
			</li>
		</ul>
	</div>
	<!-- ALL JS FILES -->
