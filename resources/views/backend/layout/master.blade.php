            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('admin-control/about/edit/1')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">About</span></a></li>
