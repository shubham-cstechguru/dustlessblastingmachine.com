...
@section('contant')
		...
		<div class="page-wrapper p-5">
		    ...
		    <h2 style="text-align: center; padding: 50px 0;"> FAQS</h2>
		            ...
		            <div class="">
		                <div class="row mb-3 ">
		                    ...
		                    <div class="col text-right">
		                    	<a href="{{ url('admin-control/faqs/add') }}" class="btn btn-primary"><i class="mdi mdi-plus"></i> Add Faq</a>
					                ...
					                <tr>
					                    ...
					                    <td>
					                    	<!-- @if(!$list->category_count) -->
						                    	<a href="{{ url('admin-control/faqs/edit/'.$list->id) }}">EDIT</a>&nbsp;|
		                    					<a href="{{ url('admin-control/faqs/remove/'.$list->id) }}"onclick="return confirm('Are you sure you want to delete this item?');">DELETE</a>
		                    				<!-- @else
